        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 32, marginBottom: 32 }}>
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
              <a href="https://instagram.com/pawbandhan" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(139,92,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#E1306C', textDecoration: 'none' }}>
                <i className="fab fa-instagram"></i>
              </a>
              <a href="https://twitter.com/pawbandhan" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(139,92,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1DA1F2', textDecoration: 'none' }}>
                <i className="fab fa-twitter"></i>
              </a>
              <a href="https://facebook.com/pawbandhan" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(139,92,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#4267B2', textDecoration: 'none' }}>
                <i className="fab fa-facebook"></i>
              </a>
              <a href="https://linkedin.com/company/pawbandhan" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(139,92,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#0077B5', textDecoration: 'none' }}>
                <i className="fab fa-linkedin"></i>
              </a>
              <a href="https://youtube.com/@pawbandhan" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(139,92,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FF0000', textDecoration: 'none' }}>
                <i className="fab fa-youtube"></i>
              </a>
              <a href="https://github.com/pawbandhan-tech" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(139,92,246,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#333', textDecoration: 'none' }}>
